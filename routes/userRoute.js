...
const { register, login, allUsers, generateQr, scanQr, uploadAvatar, twoFactorAuth, generateMailOTP, generateMobileOTP } = require("../controllers/userController");
...
router.route('/generate/mobile/otp').get(isAuthenticatedUser, generateMobileOTP)
